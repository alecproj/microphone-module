...
#define GPIO_I2S_LRCK       (GPIO_NUM_11) // 11, 14
#define GPIO_I2S_MCLK       (GPIO_NUM_NC)
#define GPIO_I2S_SCLK       (GPIO_NUM_12) // 12, 13
#define GPIO_I2S_SDIN       (GPIO_NUM_10) // 10, 9
